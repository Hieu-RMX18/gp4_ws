...
public:
  ...
  bool validate_joint_names(const std::vector<std::string> & joint_names, std::string & reason) const;
  bool validate_joint_state(const sensor_msgs::msg::JointState & joint_state, std::string & reason) const;
