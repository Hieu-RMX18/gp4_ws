...
protected:
  ...
  static industrial_msgs::msg::RobotStatus make_status(
    const int8_t e_stop,
...
{
  auto monitor_node = std::make_shared<rclcpp::Node>("robot_status_monitor_unknown_test");
  hw_adapter::RobotStatusMonitor monitor(*monitor_node, "/test_hw_adapter/status_unknown");
...
TEST_F(RobotStatusMonitorTest, estop_transitions_update_readiness)
{
  ...
  auto monitor_node = std::make_shared<rclcpp::Node>("robot_status_monitor_estop_test");
  auto publisher_node = std::make_shared<rclcpp::Node>("robot_status_monitor_estop_pub");
  ...
  auto estop_status =
    make_status(industrial_msgs::msg::TriState::TRUE, industrial_msgs::msg::TriState::FALSE);
