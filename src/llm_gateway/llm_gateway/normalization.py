"""Normalizer and geometry normalization helpers for llm_gateway commands.
...
def _rpy_to_quaternion(roll_rad: float, pitch_rad: float, yaw_rad: float) -> Any:
...
class Normalizer:
    ...
    def normalize_pose(self, raw_pose: Dict[str, Any]) -> Any:
