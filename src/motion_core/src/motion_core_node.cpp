...
public:
  ...
  MotionCoreNode()
    ...
    const auto safety_rules_yaml_path =
        declare_parameter<std::string>("safety_rules_yaml_path", "");
    if (!safety_rules_yaml_path.empty()) {
      try {
