...
private:
  ...
  void send_goal_request_callback(const ExecuteMotionSendGoalRequest::SharedPtr msg);
  void send_goal_response_callback(const ExecuteMotionSendGoalResponse::SharedPtr msg);
  ...
  rclcpp::Publisher<diagnostic_msgs::msg::DiagnosticStatus>::SharedPtr alert_pub_;
  rclcpp::Subscription<ExecuteMotionSendGoalRequest>::SharedPtr send_goal_request_sub_;
